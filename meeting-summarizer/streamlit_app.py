        ...
        with st.spinner("Processing your meeting... This may take a few minutes."):
            try:
                ...
                if response.status_code == 200:
                    ...
                    st.session_state.messages = [
                        {"role": "ai", "content": "I've analyzed your meeting! Here's the summary and you can ask me questions about it."}
                    ]
...
if st.session_state.meeting_data:
    ...
    # st.text_area(
    #     "Full transcript",
    #     value=result["transcript_preview"],
    #     height=150,
    #     disabled=True,
    ...
    st.write("Ask questions about the meeting content, decisions, or action items")
    ...
    if st.button("Analyze New Meeting"):
        st.session_state.meeting_data = None
        st.session_state.messages = []
        st.rerun()
